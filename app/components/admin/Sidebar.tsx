...
export function Sidebar({ navItems }: SidebarProps) {
  ...
  return (
    <aside className="fixed top-0 left-0 w-64 h-full bg-white border-r border-gray-200 z-40 hidden lg:block">
            ...
            {navItems.map((item) => {
              ...
              return (
                <li key={item.href}>
                  ...
                  >
                    <span className={`${isActive ? 'text-primary-600' : 'text-gray-500'} transition-colors duration-200`}>
